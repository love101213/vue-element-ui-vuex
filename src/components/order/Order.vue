...
<el-button type="primary" icon="el-icon-edit" size="mini" @click="showAddress"></el-button>
 <el-button type="success" icon="el-icon-location"  size="mini" @click="showProgress"></el-button>
  ...
  <el-form :model="ruleFormAddress" :rules="rulesAddress" ref="ruleFormAddress" label-width="100px" class="demo-ruleForm">
  <el-form-item label="省市区/县" prop="address1">
  <!-- 级联选择器 -->
 <el-cascader v-model="ruleFormAddress.address1" :options="cityDate" ></el-cascader>
  </el-form-item>
  <el-form-item label="详细地址" prop="address2">
    <el-input v-model="ruleFormAddress.address2"></el-input>
  </el-form-item>
  </el-form>
...
<el-dialog
 ...
 >
 <el-timeline>
   <el-timeline-item v-for="(activity,index) in progressInfo"  :key="index" :timestamp="activity.time" color="green" type="primary" icon="el-icon-time">{{activity.context}}</el-timeline-item>
 </el-timeline>
